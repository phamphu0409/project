										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Người dùng | Chỉnh sửa hồ sơ</h5>
												</div>
...
{
?>
<h4><?php echo htmlentities($data['fullName']);?> Hồ sơ</h4>
<p><b>Đăng ký hồ sơ Ngày: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Hồ sơ Ngày cập nhật lần cuối: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
