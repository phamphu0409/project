				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Bảng Điều Khiến</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
...
{
?>
											Tổng cuộc hẹn :<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
			...
			<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Liên Hệ Mới</h2>
...
?>
											Tổng Liên Hệ: <?php echo htmlentities($num_rows22);   ?>	
												</a>
												</a>
											</p>
										</div>
