...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Người dùng | Tiền sử bệnh</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">xem <span class="text-bold">Tiền sử bệnh</span></h5>
