...
<html lang="en">
	<head>
		<title>Bác Sĩ | Chỉnh Sửa Chi Tiết Bác Sĩ</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Bác Sĩ | Chỉnh Sửa Chi Tiết Bác Sĩ</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Bác Sĩ</span>
									...
									<li class="active">
										<span>Chỉnh Sửa Chi Tiết Bác Sĩ</span>
									</li>
								</ol>
							</div>
						</section>
...
{
?>
<h4><?php echo htmlentities($data['doctorName']);?>'Hồ Sơ</h4>
<p><b>Đăng Ký Hồ Sơ Ngày: </b><?php echo htmlentities($data['creationDate']);?></p>
