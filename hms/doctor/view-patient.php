...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Thêm Tiền Sử Bệnh</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Thêm Tiền Sử Bệnh</h5>
  ...
  <tr>
    <th>Nhiệt Độ :</th>
    <td>
    <input name="temp" placeholder="Nhiệt Độ" class="form-control wd-450" required="true"></td>
  </tr>
