...
<input type="text" name="patcontact" class="form-control"  placeholder="Nhập Số Liên Hệ" required="true" maxlength="10" pattern="[0-9]+">
</div>
<div class="form-group">
<label for="fess">
 Email Bệnh Nhân
...
<textarea type="text" name="medhis" class="form-control"  placeholder="Nhập Tiền Sử Bệnh(nếu có)" required="true"></textarea>
</div>	
